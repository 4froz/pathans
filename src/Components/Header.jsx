...
const Header = () => {
  ...
  return (
    <>
    <div className="bg-black py-2 flex flex-row justify-center">
      <p className="text-white text-sm">New Arrivals Festive Collection 2024</p>
    </div>
    <div
      className={`flex bg-[#EFEFED] border-b-[1.5px] p-4 py-4 sm:px-6  flex-row z-50 top-0 sticky w-full  items-center justify-between`}
    >
